...
**Reverse EMA:** 
    ...
    true == uses reverse EMA smoothing. can reverse hardware smoothing, snappy cursor. Follow the guide given by the Reconstructer plugin wiki to find the appropriate value (link below)
